public class Main {
    public static void main(String[] args) {
        ...
        ListaEstatica<Integer> array1 = new ListaEstatica<>();
        array1.inserir(5);
        array1.inserir(10);
        array1.inserir(15);
        array1.inserir(20);
        ...
        ListaEstatica<Integer> array2 = new ListaEstatica<>();
        array2.inserir(5);
        array2.inserir(10);
        array2.inserir(15);
        array2.inserir(20);
        ...
        ListaEstatica<Integer> array3 = new ListaEstatica<>();
        array3.inserir(5);
        array3.inserir(10);
        array3.inserir(15);
        array3.inserir(20);
        ...
        ListaEstatica<Integer> array4 = new ListaEstatica<>();
        array4.inserir(5);
        array4.inserir(10);
        array4.inserir(15);
        array4.inserir(20);
        ...
        ListaEstatica<Integer> array5 = new ListaEstatica<>();
        array5.inserir(5);
        array5.inserir(10);
        array5.inserir(15);
        array5.inserir(20);
        ...
        ListaEstatica<Integer> array6 = new ListaEstatica<>();
        for(int i = 0; i < 15; i++){
            array6.inserir(i+1);
        }
        ...
        ListaEstatica<Integer> array7 = new ListaEstatica<>();
        array7.inserir(5);
        array7.inserir(10);
        array7.inserir(15);
        array7.inserir(20);
        ...
        ListaEstatica<Integer> array8 = new ListaEstatica<>();
        array8.inserir(5);
        array8.inserir(10);
        array8.inserir(15);
        array8.inserir(20);
        ...
        ListaEstatica<Integer> array9 = new ListaEstatica<>();
        array9.inserir(5);
        array9.inserir(10);
        array9.inserir(15);
        array9.inserir(20);
        ...
        //[X] CASO 10 - Certificar que inverter() inverte corretamente o vetor
        //Descrição: Criar uma lista para testar o método inverter() com quantidade par de dados
        //Saída esperada: o método toString() deve resultar em 20,15,10,5

        ListaEstatica<Integer> array10 = new ListaEstatica<>();
        array10.inserir(5);
        array10.inserir(10);
        array10.inserir(15);
        array10.inserir(20);
        ...
        array10.inverter();
        System.out.println("Caso 10: " + array10.toString());

        System.out.println("---------------");

        //[X] CASO 11 - Certificar que inverter() inverte corretamente o vetor
        //Descrição: Criar uma lista para testar o método inverter() com quantidade ímpar de dados
        //Saída esperada: o método toString() deve resultar em 25,20,15,10,5

        ListaEstatica<Integer> array11 = new ListaEstatica<>();
        array11.inserir(5);
        array11.inserir(10);
        array11.inserir(15);
        array11.inserir(20);
        ...
        array11.inverter();
        System.out.println("Caso 11: " + array11.toString());

        System.out.println("---------------");

//        ListaEstatica<Aluno> listaAlunos = new ListaEstatica<>();
//
//        Aluno a1 = new Aluno("May", 101);
//        Aluno a2 = new Aluno("Ana", 202);
//        System.out.println("Lista: " + listaAlunos);
//        listaAlunos.inserir(a1);
//        listaAlunos.inserir(a2);
//        System.out.println("Lista: " + listaAlunos);
//        System.out.println("Buscar Aluno: " + listaAlunos.buscar(new Aluno("May", 101)));
