...
@router.get(
    "",
    response_model=EquipamentoListaOut,
    summary="Lista todos os equipamentos",
    description="Retorna todos os equipamentos cadastrados com seus respectivos tipos.",
)
...
@router.post(
    ...
    responses={
        ...
        400: {"description": "Tipo de equipamento inválido"},
